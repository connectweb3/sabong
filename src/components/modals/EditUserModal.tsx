            ...
            <div className="bg-neutral-800 rounded-xl border border-neutral-700 w-full max-w-md shadow-2xl overflow-hidden">
                ...
                <div className="p-6">
                    ...
                    <form onSubmit={handleUpdate} className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-neutral-400 mb-1">Credits Balance</label>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-neutral-900 border border-neutral-700 rounded-lg p-2.5 pl-8 text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all"
                                    placeholder="0"
                                    min="0"
                                    step="0.01"
                                    required
                            ...
                            <p className="text-xs text-neutral-500 mt-1">Set the exact balance for this user</p>
                        </div>
