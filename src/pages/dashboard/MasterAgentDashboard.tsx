...
import { UserPlus, Copy, Check, Users, TrendingUp, Clock } from 'lucide-react';
        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 font-bold transition-colors text-sm"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-neutral-800 p-6 rounded-xl border border-neutral-700">
                    ...
                    <p className="text-3xl font-bold text-white mt-2">{downlineCount.agents}</p>
                </div>
                <div className="bg-neutral-800 p-6 rounded-xl border border-neutral-700">
                    <h3 className="text-neutral-400 text-sm font-medium flex items-center gap-2">
                    ...
                    <p className="text-3xl font-bold text-white mt-2">{downlineCount.users}</p>
                </div>
                <div className="bg-neutral-800 p-6 rounded-xl border border-neutral-700">
                    <h3 className="text-neutral-400 text-sm font-medium flex items-center gap-2">
            ...
            <div className="bg-neutral-800 rounded-xl border border-neutral-700 overflow-hidden shadow-2xl">
                <div className="p-4 bg-purple-600/10 border-b border-purple-500/20 flex justify-between items-center">
                    <h3 className="text-purple-500 font-black uppercase text-sm tracking-widest flex items-center gap-2">
                        <UserPlus className="w-4 h-4" />
                                        ...
                                        <td className="p-4 text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                <button
                                                    ...
                                                    className="bg-purple-600 hover:bg-purple-700 text-white px-3 py-1 rounded-lg text-xs font-bold disabled:opacity-50 transition-all font-display uppercase tracking-wider"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    disabled={!!actionLoading}
                                                    className="bg-neutral-700 hover:bg-red-900 text-white px-3 py-1 rounded-lg text-xs font-bold disabled:opacity-50 transition-all font-display uppercase tracking-wider"
                                                >
                                                    Reject
                                                </button>
                                            </div>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-neutral-700">
                            {requests.length === 0 ? (
                                <tr>
                                    <td colSpan={5} className="p-8 text-center text-neutral-500 italic">No pending requests from your direct downline.</td>
                                </tr>
                            ) : (
                                requests.map((req) => (
            ...
            <div className="bg-neutral-800 p-6 rounded-xl border border-neutral-700">
                <h3 className="text-white font-bold mb-4">Referral Link</h3>
                <div className="flex gap-2">
                    <input
                        type="text"
                        readOnly
                ...
                <p className="text-neutral-500 text-xs mt-2">Share this link to automatically recruit Agents or Players under your account.</p>
            </div>
            ...
            {session && (
                <CreateUserModal
                    ...
                    title={createType === 'agent' ? 'Create New Agent' : 'Create New Player'}
                />
            )}
        </div>
    );
